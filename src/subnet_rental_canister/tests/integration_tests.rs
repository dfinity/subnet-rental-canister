...
fn test_create_rental_agreement() {
    ...
    let cmc_exchange_rate_icp_to_xdr_at_proposal_execution = 3_497_900_000; // 1 ICP = 3.4979 XDR
    set_cmc_exchange_rate(&pic, cmc_exchange_rate_icp_to_xdr_at_proposal_execution);
    ...
    let expected_locked_cycles_first_locking =
        (icp_to_be_locked * cmc_exchange_rate_icp_to_xdr_at_proposal_execution as u128) / 100_000;
